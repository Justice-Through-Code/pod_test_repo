...
print()
print(f'The URL for the Apple Macbook Pro: {laptops[0]["url"]}')
print()

# TODO: Write code to print all possible prices of the 16-inch MacBook Pro.

print(f'These are all possible prices of the 16-inch MacBook Pro: {laptops[0]["types"][1]["price"]}')
print()

# TODO: Write code to print all the color options for Dell XPS 13.

print(f'All the color options for Dell XPS 13 are: {laptops[1]["types"][0]["colors"]}')
print()

# TODO: Write code to print the description of Dell XPS laptop.

print(f'The description of Dell XPS is the following: {laptops[1]["description"]}')
print()
...
#laptops[0]["types"][0]["colors"].remove["space gray"] #- why isn't this working?
...
for productName in laptops:
    for product_type in productName['types']:
